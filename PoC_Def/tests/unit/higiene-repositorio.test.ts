...
describe("higiene del repositorio", () => {
  it("no versiona artefactos generados por una ejecución o por TypeScript", () => {
    const generados = [
      "PoC_Def/data/aprendizaje/ejecuciones.json",
      "PoC_Def/data/aprendizaje/lecciones.json",
      "PoC_Def/data/url-publica.txt",
      "PoC_Def/tsconfig.tsbuildinfo",
    ];
  ...
  it("permite añadir nuevos protocolos bajo data/protocolos", () => {
    const candidato = "PoC_Def/data/protocolos/nuevo-protocolo.md";
