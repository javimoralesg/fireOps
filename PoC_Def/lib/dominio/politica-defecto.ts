...
export const REGLAS_POR_DEFECTO: ReglaAutonomia[] = [
  ...
  { tipoAccion: "llamar", modo: "supervisada", riesgoMinimo: 30, descripcion: "Llamada de voz automática a ayuntamientos, unidades o particulares" },
  ...
  { tipoAccion: "avisar_poblacion", modo: "autonoma", riesgoMinimo: 20, descripcion: "Aviso preventivo a una población (llamada al ayuntamiento, SMS y Telegram): se hace solo, como las alertas oficiales; confinar y evacuar siguen siendo de una persona" },
